    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-heading font-bold text-[#0B1F3A]">Edit Category</h1>
            <p className="text-slate-500 text-sm">Update {category.name}</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                ...
                <input type="text" name="name" defaultValue={category.name} required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:bg-white transition-all" placeholder="e.g. Spices" />
              </div>
            </div>
