...
export function EditProductForm({ product, categories }: { product: any, categories: string[] }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div>
              ...
              <input type="text" name="name" defaultValue={product.name} required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:bg-white transition-all" />
            </div>
            ...
            <div>
              ...
              <input type="text" name="badge" defaultValue={product.badge} required className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:bg-white transition-all" />
            </div>
          </div>
        ...
        <div className="mt-6">
          ...
          <textarea name="description" defaultValue={product.description} required rows={4} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:bg-white transition-all resize-y" />
        </div>
        ...
        <input type="hidden" name="bgColor" value={product.bgColor} />
        <input type="hidden" name="pillBg" value={product.pillBg} />
        <input type="hidden" name="pillText" value={product.pillText} />
      </div>
    </form>
  );
}
